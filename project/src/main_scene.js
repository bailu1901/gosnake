...
var TestLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        */
       cc.loader.loadJson("res/NewUI_1.ExportJson");
        var root = ccs.uiReader.widgetFromJsonFile("res/NewUI_1.ExportJson");
        this.addChild(root, 0);

        //var spr = cc.Sprite.create("res/HelloWorld_11.png");
        //this.addChild(spr, 1);
